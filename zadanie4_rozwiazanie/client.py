...
def thread_updating_data(n,c):
    global buffer_player1, buffer_player1_recv, buffer_player2, buffer_ball, game, opponent_connected
    while True:
        try:
            bufp1 = buffer_player1
            buffer_player1 = Buffer()
            buffer_player1_recv, buffer_player2, buffer_ball, game, opponent_connected = n.send(bufp1)
